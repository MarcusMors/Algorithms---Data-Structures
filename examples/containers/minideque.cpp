...
#include "../../containers/minideque.hpp"
...
int main()
{
  std::vector<int> input{ 5, 1, 6, 3, 9, 2, 4, 8, 10, 7 };
  fstd::minideque<int> list;
  // fstd::minideque<int> list{ 1, 5, 17, 5, 12, 15, 20, 32, 32 };// NOLINT magic numbers
  // fstd::minideque<int> list{ 1, 2 };// NOLINT magic numbers
